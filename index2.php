...
<head>
	...
	<meta name="description" content="Library Management,Website for BMSCE	">
	<meta name="keywords" content="Library Management BMSCE, Online Courses BMSCE ">	
     <title> Library Management | BMSCE</title>

	<!-- tab img -->
	<link rel="shortcut icon" type="image/x-icon" href="asset/img/4.png">
	...
	<div id="navigation">
		<div class="container">
			<div class="row">
				<div class="col-sm-3">
					<div class="logo">
						<a href="index.html" >Library Management BMSCE </a>
					</div>
				</div>
						...
						<div class="navbar">
							...
							<div class="navbar-collapse collapse">
								<ul class="nav navbar-nav navbar-right">
									...
									<!--<li><a class="smoth-scroll" href="#skills">Courses</a></li>-->
		...
		<div class="container">
			<div class="row">
				<div class="description col-md-6 col-sm-4 col-xs-12">
					...
					<h4> DBMS Project | BMSCE Bengaluru, India</h4>
					<p> Our Project <em> ' LIBRARY MANAGEMENT ' </em>  sole purpose is to build a system is to manage daily operationS of our library efficiently. 	
		...
		<div class="container text-center">
			<div class="row">
				<div class="col-md-20 text-center">
					<h2> Student Registeration | Faculty Registeration </h2>
				</div>
				...
				<div class="col-md-18 col-sm-6">
					<div class="blog-item">
						<div class="blog-desc">
							<h4>
								<a > Student Registration</a>
							</h4>
							<a href="https://en.wikipedia.org/wiki/Data_science" target="_blank" class="btn btn-dark" id="readmore">Read More</a>
				...
				<div class="col-md-4 col-sm-6">
					<div class="blog-item">
						<div class="blog-desc">
							<h4>
								<a  > Faculty Registeration</a>
							</h4>
							<!--<a href="https://en.wikipedia.org/wiki/Data_science" target="_blank" class="btn btn-dark" id="readmore">Read More</a> -->
							<a href="form2.html" target="_blank" class="btn btn-dark " id="register">Faculty Register</a>
						</div>
					</div>
				</div>
		...
		<div class="container text-center">
			<div class="row">
				<div class="col-md-12 text-center">
					<h2>Books Available | New Arrivals | Updation </h2>
				</div>
				...
				<div class="col-md-4 col-sm-6">
					<div class="blog-item">
						...
						<div class="blog-desc">
							...
							<p>This section contains the list of available books- currently in our BMSCE library repository.</p>
				...
				<div class="col-md-4 col-sm-6">
					<div class="blog-item">
						...
						<div class="blog-desc">
							...
							<p>This section of Books Info. contains the list of new arrivals books- ranging from fictions to theory.</p>
							<a href="https://en.wikipedia.org/wiki/Data_science" target="_blank" class="btn btn-dark" id="readmore">View</a>
						</div>
					</div>
				</div>
...
<!-- -- ----------------------------------formspree !------------------------------------------------------------------------------------------------------------------------------------------------>
				<!--div class="col-md-8 col-md-offset-2">
					<form id="contact-form" name="contact" method="POST" action="https://formspree.io/rajath.18cs@bmsce.ac.in">
						<div class="row">
		...
		<div class="container">
			<div class="col-md-12 text-center">
				...
				<ul class="social-icons-footer">
						...
						<li><a href="https://twitter.com/bmsconnectplus?lang=en" target="_blank"><i class="fa fa-twitter"></i></a></li>
				
						<li><a href="https://in.linkedin.com/company/bmsce" target="_blank"><i class="fa fa-linkedin"></i></a></li>
			
			
						<li><a href="mailto:info@bms.ac.in" target="_blank"><i class="fa fa-envelope"></i></a></li>
					</ul>
			</div>
		</div>
	</footer>
