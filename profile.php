...
<link rel="shortcut icon" type="image/x-icon" href="asset/img/bmsce.jpg">
...
<p> Our Project <em> ' LIBRARY MANAGEMENT ' </em>  A modern , efficient way of interacting with the vast ocean of books in an organised fashion.
<br>
</p> 
</div>
...
<h2> Student Registration |  Registered Student Details </h2>
</div>
...
<p>This section contains the list of available books- currently in our BMS library repository.</p>
...
<li><a href="mailto:info@bmsce.ac.in" target="_blank"><i class="fa fa-envelope"></i></a></li>
</ul>
</div>
</div>
</footer>
